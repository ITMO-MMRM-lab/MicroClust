...
![GitHub last commit](https://img.shields.io/github/last-commit/ITMO-MMRM-lab/MicroClust)
![GitHub Release](https://img.shields.io/github/v/release/ITMO-MMRM-lab/MicroClust)
![GitHub License](https://img.shields.io/github/license/ITMO-MMRM-lab/MicroClust)
...
- *Installation:*
```
git clone https://github.com/ITMO-MMRM-lab/MicroClust
```
``` git clone https://github.com/ITMO-MMRM-lab/MicroClust <YOUR CUSTOM DIRECTORY>```
